"""Open-loop action trajectory analysis: baseline vs L13-full-ablation on LIBERO demo observations."""
...
def main():
    ...
    print(f"Ablation: L{LAYER_IDX} all 32 heads zeroed (full layer ablation)")
    ...
    out_path = os.path.join(RESULTS_DIR, "action_trajectory_L13_ablation.json")
