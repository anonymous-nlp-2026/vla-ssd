...
OUT_PATH = Path("./results/permutation_10k/rsa_permutation_null_10k.json")
...
def main():
    ...
    if all_sig:
        conclusion = "All observed RSA values are statistically significant (p < 0.001, permutation test with 10000 shuffles)"
    else:
    ...
    output = {
        "method": "RSA permutation test (10000 shuffles)",
