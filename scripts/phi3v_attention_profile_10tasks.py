...
RESULT_PATH = "./results/attention/phi3v_attention_profile_10tasks.json"
...
def main():
    ...
    task_data = []
    for hdf5_path in hdf5_files[:10]:
    ...
    compat_path = os.path.join(OUTPUT_DIR, "full_32layer_phi3v_10tasks.json")
