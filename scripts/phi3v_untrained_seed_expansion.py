"""Phi3V UNTRAINED R2 probe seed expansion: seeds 5-14.

Extends phi3v_r2_untrained_probe.py (seeds 0-4) to 15 total seeds.
Phase 2 only — features already extracted in phi3v_untrained_libero_goal/.
"""
import glob
import json
import os
...
OUT_DIR = "./results/phi3v_untrained_seed_expansion/"
OUT_JSON = os.path.join(OUT_DIR, "phi3v_untrained_seed_expansion.json")
...
def main():
    ...
    print("=" * 60)
    print("Phi3V UNTRAINED R2 Probe — Seed Expansion (5-14)")
    print(f"Seeds: {SEEDS}")
    ...
    output = {
        ...
        "base_llm": "<HF_CACHE>/Phi-3-mini-4k-instruct",
