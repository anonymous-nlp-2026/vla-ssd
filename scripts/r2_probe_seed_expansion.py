"""Three-condition multi-seed action R2 probe — 15-seed expansion.

Based on threecond_multiseed_probe_v2.py. Changes:
  - Seeds expanded from [42, 123, 456] to list(range(15))
  - Device: cuda:1
  - Output path: functional_validation/r2_probe_15seeds.json
"""
...
OUT_JSON = "./results/functional_validation/r2_probe_15seeds.json"
OUT_FIG_DIR = "./results/functional_validation/figures/"
...
def make_figure(results):
    ...
    ax.set_title("Per-Layer Action R2 (15 seeds, fixed split)", fontsize=12)
    ...
    fig.tight_layout()
    fig.savefig(os.path.join(OUT_FIG_DIR, "fig_r2_probe_15seeds.pdf"),
                bbox_inches="tight")
    fig.savefig(os.path.join(OUT_FIG_DIR, "fig_r2_probe_15seeds.png"),
...
def main():
    ...
    print("=" * 60)
    print("Three-condition multi-seed action R2 probe (15-seed expansion)")
